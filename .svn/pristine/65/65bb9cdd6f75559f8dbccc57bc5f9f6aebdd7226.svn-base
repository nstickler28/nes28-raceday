...
public class StatusBar extends JPanel implements PropertyChangeListener {
     ...
     * 
     */
    private static final long serialVersionUID = -658768479718552166L;

    /** The separator for formatting. */
    private static final String SEPARATOR = ":";

    /** String character for string builder. */
    ...
    private void setUpComponents() {
        ...
        myTimer.setFont(FONT);
        myTimer.setBorder(BorderFactory.createEmptyBorder(PADDING, PADDING, PADDING, PADDING));
        myParticipant.setFont(FONT);
        myParticipantInfo.setFont(FONT);
        myParticipant.setBorder(BorderFactory.createEmptyBorder(PADDING, PADDING, PADDING,
                                                                PADDING));
    ...
    private String formatTime(final long theTime) {
        ...
        time /= MIN_PER_HOUR;
        return "<html>Time: <b><i>" + TWO_DIGIT_FORMAT.format(min) + SEPARATOR
    ...
    public void propertyChange(final PropertyChangeEvent theEvent) {
        if (PROPERTY_TIME.equals(theEvent.getPropertyName())) {
            ...
            myTimer.setText(formatTime(myTime));
