...
public interface RaceControls {
    ...
    /**
     * Start the race when play button is clicked.
     */
    void togglePlay();
    
    /**
     * Toggle speed when button is clicked and change icon.
     */
    void toggleSpeed();
    
    /**
     * When button is clicked repeat race while loop is on when race finishes.
     */
    void toggleLoopRace();
